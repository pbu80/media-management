...
mapfile -t audio_props < <(ffprobe -v error -select_streams a:0 -show_entries stream=channels,sample_rate -of default=noprint_wrappers=1:nokey=1 "$first_segment" || true)
